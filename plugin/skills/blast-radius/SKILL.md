...
Companion to `how`, which tells you what the code does. Blast radius tells you what it breaks somewhere else.
...
6. For a big or wide change, fan out. Spawn several subagents on the same question with different starting angles and merge the answers. Different angles catch different real bugs.

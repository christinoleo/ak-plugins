...
description: |
  ...
  /plan-to-issues → verify issues. Your main session does all the work (it has the
...
Tell the user:
"Trigger agent spawned at `<TRIGGER_TARGET>`. It will drive this session through planning → replan → issue conversion. Sit back and watch — the trigger will send commands here."
